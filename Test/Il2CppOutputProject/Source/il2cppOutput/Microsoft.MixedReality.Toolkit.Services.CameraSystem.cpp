...
IL_0140:
	{
		...
		MixedRealityPlayspace_set_Position_m451C6842F05D76C66A761B82CF8173E4EBA6CE2E(L_48, /*hidden argument*/NULL);
		...
		MixedRealityPlayspace_set_Rotation_m2B03926702AFD634E7D0488454B8090883C57F38(L_49, /*hidden argument*/NULL);
		// if (CameraCache.Main.transform.position != Vector3.zero)
		Camera_tC44E094BAB53AFC8A014C6F9CFCE11F4FC38006C * L_50;
		L_50 = CameraCache_get_Main_m124F1E5A07D1C1EAC34DC9E069A59FFEDEDDBD19(/*hidden argument*/NULL);
		NullCheck(L_50);
...
IL_0191:
	{
		...
		L_60 = CameraCache_get_Main_m124F1E5A07D1C1EAC34DC9E069A59FFEDEDDBD19(/*hidden argument*/NULL);
		NullCheck(L_60);
